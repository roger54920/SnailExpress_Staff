 ...
 * 收快递 货柜编号
 */
public class ReceiveExpressageContainerActivity extends AutoLayoutActivity implements HistoicFlowView{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_receive_expressage_container);
