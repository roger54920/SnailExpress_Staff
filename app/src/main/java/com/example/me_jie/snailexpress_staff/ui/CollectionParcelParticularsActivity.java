 ...
 * 代收包裹详情
 */
public class CollectionParcelParticularsActivity extends AutoLayoutActivity implements HistoicFlowView{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_collection_parcel_particulars);
