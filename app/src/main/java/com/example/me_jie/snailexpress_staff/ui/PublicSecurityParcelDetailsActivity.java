 ...
 * 保安包裹详情
 */
public class PublicSecurityParcelDetailsActivity extends AutoLayoutActivity implements HistoicFlowView{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_public_security_parcel_details);
