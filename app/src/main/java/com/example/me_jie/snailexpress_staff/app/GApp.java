package com.example.me_jie.snailexpress_staff.app;
...
public class GApp extends Application {
    ...
    public void onCreate() {
        ...
        SpeechUtility.createUtility(GApp.this, "appid=" + getString(R.string.app_id));
...
//                    .setCertificates(getAssets().open("tomcat7.keystore"))      //方法二：也可以自己设置https证书（选一种即可）
