 ...
 * 站长 扫码包裹详情
 */
public class AdministratorParcelParticularsActivity extends AutoLayoutActivity implements HistoicFlowView{
    ...
    @InjectView(R.id.confirm_receipt_btn)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_administrator_parcel_particulars);
    ...
    @OnClick({R.id.zoom, R.id.confirm_receipt_btn,R.id.return_arrows})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.return_arrows:
                finish();
                break;
            case R.id.confirm_receipt_btn:
                intent = new Intent(AdministratorParcelParticularsActivity.this,AdministratorCameraActivity.class);
