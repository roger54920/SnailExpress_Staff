 ...
 * 超期包裹 收费
 */
public class ExceedTimeParcelChargeActivity extends AutoLayoutActivity implements HistoicFlowView{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exceed_time_parcel_charge);
